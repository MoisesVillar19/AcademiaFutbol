...
===============================================================================
Fecha: 2026-09-06 | Versión: v1.0.1 | Alternativa ZIP incluida
...
[B] Archivo bloqueado "No se puede ejecutar" / Zone.Identifier
    ...
    - PowerShell (recomendado):
      ...
      Unblock-File -Path ".\AcademiaFutbol-v1.0.1.zip"  (si usas ZIP)
      # verificar/fix ADS:
...
[C] Defender/Antivirus lo borra ("Amenaza encontrada")
    ...
    - Verificación SHA256 (hash del Release, copy/paste):
      certutil -hashfile AcademiaFutbol-Setup-1.0.1.exe SHA256
      certutil -hashfile AcademiaFutbol-v1.0.1.zip SHA256
...
[D] Sin permiso de admin / no puedes instalar en C:\Program Files\ (PC bloqueada, cabina)
    ...
    1. Unblock-File AcademiaFutbol-v1.0.1.zip (desbloquear ZIP primero!)
...
Logs si da PermissionError (ya fix v1.0.1):
...
Hashes SHA256 del Release:
  (ver GitHub Releases v1.0.1 notas o ejecutar certutil arriba)
